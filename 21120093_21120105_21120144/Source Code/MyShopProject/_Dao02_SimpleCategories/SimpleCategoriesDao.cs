...
namespace _Dao02_SimpleCategories
{
    public class SimpleCategoriesDao : CategoriesIDao
    {
        ...
        public override int add(Category cate)
        {
            ...
            command.Parameters.Add("@name", System.Data.SqlDbType.NVarChar).Value = cate.Name;
            command.Parameters.Add("@desc", System.Data.SqlDbType.NVarChar).Value = cate.Description;
